...
1. [Filter Toolbar](#1-filter-toolbar)
   - [View & Sorting](#11-view--sorting)
   - [Quick Toggles](#12-quick-toggles)
   - [Meal Plans](#13-meal-plans)
   - [Star Rating](#14-star-rating)
   - [Location & Distance](#15-location--distance)
   - [Additional Controls](#16-additional-controls)
2. [Sidebar](#2-sidebar)
   - [Sidebar Tabs](#21-sidebar-tabs)
   - [Search Filters](#22-search-filters)
   - [Hotel Facilities](#23-hotel-facilities)
3. [Results Tabs](#3-results-tabs)
   - [Room AI](#31-room-ai)
4. [Hotel Card](#4-hotel-card)
...
| **Distance: (0 - 100)** | Nearest hotels first (from the city center, or from the point selected in [Location & Distance](#15-location--distance)). |
...
| Tab | Description |
|---|---|
| 🛏 **Search filters** | Filters by hotel name, room name, price, hotel type, and room type. See [2.2](#22-search-filters). |
| 🏢 **Hotel** | Hotel-level filters: **Hotel facilities**. See [2.3](#23-hotel-facilities). |
...
| **Room AI** | Filters by room attributes recognised by AI. See [3.1](#31-room-ai). |
...
| **Distance** (e.g. `14.1km`) | Distance from the city center, or from the point selected in [Location & Distance](#15-location--distance). |
...
| **Meal plan badge** | Board type included in the price: **RO** – Room Only (no meals), **BB** – Bed & Breakfast, **M** – Meal. See also [Meal Plans](#13-meal-plans). |
